<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="User.aspx.vb" Inherits="FRITS.User"
...
<head runat="server">
    ...
    function delMemberOf() {
        ...
        if (confirm('Do you really want to remove the selected member of?')) {
            lstMemberOfCallBack.Callback('delete:memberof', snode.Value);
        }
    }
...
<body class="dialog">
    <form id="frm" runat="server">
        ...
        <asp:Panel ID="pnlContentPane" runat="server">
            <div id="Toolbar" style="border-right: silver 0px solid; padding-right: 5px; border-top: silver 0px solid; padding-left: 5px; padding-bottom: 0px; border-left: silver 0px solid; padding-top: 0px; border-bottom: silver 0px solid; background-color: #FFFFFF;"
                    ...
                    <tr>
                        <td valign="top">
                            <ComponentArt:TabStrip ID="TabStrip" runat="server" DefaultItemLookId="DefaultTabLook"
                                ...
                                DefaultGroupTabSpacing="1" MultiPageId="MultiPage" SiteMapXmlFile="~/Resources/XML/tabUser.xml"
                                                        ...
                                                        <td nowrap valign="top">
                                                            <table cellspacing="0" cellpadding="3" border="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td nowrap height="25">
                                                                        <asp:TextBox ID="txtName" runat="server" Width="200px" CssClass="TextBox"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td nowrap height="25">Description
                                                                    </td>
                                                                    <td nowrap align="center" height="25">:
                                                                    </td>
                                                                    <td nowrap height="25">
                                                                        <asp:TextBox ID="txtDesc" runat="server" Width="200px" CssClass="TextBox"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td nowrap height="25">Email Address
                                                                    </td>
                                                                    <td nowrap align="center" height="25">:
                                                                    </td>
                                                                    <td nowrap height="25">
                                                                        <asp:TextBox ID="txtEmailAddress" runat="server" Width="200px" CssClass="TextBox"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td nowrap height="25">Department
                                                                    </td>
                                                                    <td nowrap align="center" height="25">:
                                                                    </td>
                                                                    <td nowrap height="25">
                                                                        <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="DropDownList" DataSourceID="DepartmentSqlDataSource"
                                                                            DataTextField="Name" DataValueField="DepartmentID" AutoPostBack="false">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td nowrap height="25">Branch
                                                                    </td>
                                                                    <td nowrap align="center" height="25">:
                                                                    </td>
                                                                    <td nowrap height="25">
                                                                        <asp:DropDownList ID="ddlBranch" runat="server" CssClass="DropDownList" DataSourceID="BranchSqlDataSource"
                                                                            DataTextField="Name" DataValueField="Code" AutoPostBack="false">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <span id="ltlChange" runat="server">
                                                                    <tr>
                                                                        <td nowrap height="25">Change Password
                                                                        </td>
                                                                        <td nowrap align="center" height="25">:
                                                                        </td>
                                                                        <td nowrap height="25">
                                                                            <asp:CheckBox ID="chkChangePassword" runat="server" AutoPostBack="true" />
                                                                        </td>
                                                                    </tr>
                                                                </span>
                                                                <tr>
                                                                    <td nowrap height="25">Password
                                                                    </td>
                                                                    <td nowrap align="center" height="25">:
                                                                    </td>
                                                                    <td nowrap height="25">
                                                                ...
                                                                <tr>
                                                                    <td nowrap height="25">Confirm Password
                                                                    </td>
                                                                    <td nowrap align="center" height="25">:
                                                                    </td>
                                                                    <td nowrap height="25">
                                            ...
                                            <tr>
                                                <td nowrap valign="top">
                                                    <ComponentArt:CallBack ID="lstMemberOfCallBack" CssClass="CallBack" runat="server">
                                                        <Content>
                                                            <ComponentArt:TreeView ID="lstMemberOf" runat="server" Height="150" Width="100%"
            ...
            <asp:SqlDataSource ID="BranchSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:EASLConnectionString %>"></asp:SqlDataSource>
            <asp:SqlDataSource ID="DepartmentSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:EASLConnectionString %>"></asp:SqlDataSource>
        </asp:Panel>
    </form>
</body>
</html>
