...
Public Delegate Sub CustomSummaryOperation(column As String, groupName As String, value As Object)
Public Delegate Function SummaryResultMethod(column As String, groupName As String) As Object
...
Public Class GridViewSummary
	...
	Private Sub New(col As String, grp As GridViewGroup)
		Me._column = col
		Me._group = grp
		Me._value = Nothing
		Me._quantity = 0
	...
	Public Sub New(col As String, formatString As String, op As SummaryOperation, grp As GridViewGroup)
		Me.New(col, grp)
	...
	Public Sub New(col As String, op As SummaryOperation, grp As GridViewGroup)
		Me.New(col, [String].Empty, op, grp)
	End Sub

	Public Sub New(col As String, formatString As String, op As CustomSummaryOperation, getResult As SummaryResultMethod, grp As GridViewGroup)
		Me.New(col, grp)
		Me._formatString = formatString
	...
	Public Sub New(col As String, op As CustomSummaryOperation, getResult As SummaryResultMethod, grp As GridViewGroup)
		Me.New(col, [String].Empty, op, getResult, grp)
	End Sub

	#End Region

	Friend Sub SetGroup(g As GridViewGroup)
		Me._group = g
	End Sub
	...
	Public Sub AddValue(newValue As Object)
	...
	Private Function PerformSum(a As Object, b As Object) As Object
	...
	Private Function PerformDiv(a As Object, b As Integer) As Object
		Dim zero As Object = 0

		If a Is Nothing Then
			Return (If(_treatNullAsZero, zero, Nothing))
		End If
