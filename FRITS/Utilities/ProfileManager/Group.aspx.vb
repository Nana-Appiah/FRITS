...
#Region " Methods"
    ...
    Private Sub GetData()
        Try
            ...
            group = Me.ARConn.GetGroupByID(Me.ObjectID)

            If Not (group Is Nothing) Then

                Try
                    If Not group.ObjectName Is DBNull.Value Then
                        Me.txtName.Text = group.ObjectName
                    End If
                Catch ex As Exception
                End Try

                Try
                    If Not group.ObjectDescription Is DBNull.Value Then
                        Me.txtDesc.Text = group.ObjectDescription
                    End If
                Catch ex As Exception
                End Try

                Try
                    If Not IsDBNull(group.ValidFrom) Then
                        Me.PickerFrom.SelectedDate = group.ValidFrom
                    End If
                Catch ex As Exception
                End Try

                Try
                    If Not IsDBNull(group.ValidTo) Then
                        Me.PickerTo.SelectedDate = group.ValidTo
                    End If
                Catch ex As Exception
                End Try
    ...
    Private Sub SaveData()
        Try
            ...
            If Not Me.ObjectID = Nothing Then
                ...
                group.ObjectName = Me.txtName.Text
                group.ObjectDescription = Me.txtDesc.Text
                group.ValidFrom = Me.PickerFrom.SelectedDate
                group.ValidTo = Me.PickerTo.SelectedDate
                group.ObjectAlias = Me.txtName.Text.Replace(" ", "_").ToLower
                group.Update()

                'Log into auditing log
                Me.Log(Me.CurrentUser.ObjectID, Me.GetResourceID(Me.ObjectAlias), Me.ResManager.GetString("GroupDetails.Log.Change", Thread.CurrentThread.CurrentUICulture) & " " & group.ObjectName, "FRITS")
            ...
            Else
                ...
                If Me.txtName.Text = "" Then
                    'Display message
                    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "jsCall", "alert('" & Me.ResManager.GetString("GroupNew.lblErrorUserGroupName.Empty", Thread.CurrentThread.CurrentUICulture) & "');", True)
                Else
                    Try
                        'Create new group
                        group.ObjectName = Me.txtName.Text
                        ...
                        'Log into auditing log
                        Me.Log(Me.CurrentUser.ObjectID, Me.GetResourceID(Me.ObjectAlias), Me.ResManager.GetString("GroupNew.Log.InsertNew", Thread.CurrentThread.CurrentUICulture) & " " & group.ObjectAlias, "FRITS")

                        'Display message and close window
                        ScriptManager.RegisterStartupScript(Me, Me.GetType(), "jsCall", "alert('" & Me.ResManager.GetString("GroupNew.lblMessage.Created", Thread.CurrentThread.CurrentUICulture) & "');parent.returnValue='reload';", True)
                    ...
                    Catch exc As Exception
                        'Display message
                        ScriptManager.RegisterStartupScript(Me, Me.GetType(), "jsCall", "alert('" & Me.ResManager.GetString("GroupNew.lblMessage.Error", Thread.CurrentThread.CurrentUICulture) & "');", True)
                        Exit Sub
                    End Try
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            'Set resource id
            Me.ObjectAlias = "frits.utilities.profilemanager.groups"
            ...
            If Not Me.Page.IsPostBack Then
                ...
                Else
                    ...
                    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "jsCall", "parent.window.document.title='New Group';", True)
                End If
