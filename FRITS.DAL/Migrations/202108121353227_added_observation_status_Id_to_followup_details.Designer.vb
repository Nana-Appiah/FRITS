...
Namespace Migrations
    ...
    Public NotInheritable Partial Class added_observation_status_Id_to_followup_details
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(added_observation_status_Id_to_followup_details))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202108121353227_added_observation_status_Id_to_followup_details"
            End Get
        End Property
